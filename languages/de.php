<?php
/*
 * Modified Core Language
 * @package Elgg.Core
 * @subpackage Languages.German
 */
$de_extend = array(
  'table_columns:fromView:admin' => 'Administrator',
  'table_columns:fromView:banned' => 'Verbannt',
  'table_columns:fromView:excerpt' => 'Beschreibung',
  'table_columns:fromView:link' => 'Name/Titel',
  'table_columns:fromView:language' => 'Sprache',
  'table_columns:fromView:time_created' => 'Erstellungszeit',
  ...
  'table_columns:fromProperty:email' => 'E-Mai',
  'loginusername' => 'Benutzername oder E-Mail',
  'profile:contactemail' => 'E-Mail-Kontaktadresse',
  'profile:field:email' => 'E-Mail-Adresse',
  'profile:invalid_email' => '%s muss eine gültige E-Mail-Adresse sein.',
  'notification:method:email' => 'E-Mail',
  'registration:notemail' => 'Die von dir angegebene E-Mail-Adresse scheint keine gültige Email-Adresse zu sein.',
  'registration:dupeemail' => 'Diese E-Mail-Adresse ist schon bei einer früheren Registrierung verwendet worden.',
  'user:password:changereq:success' => 'Die Anforderung eines neuen Passworts war erfolgreich. Eine E-Mail mit dem neuen Passwort wurde gesendet.',
  'admin:plugins:label:contributors:email' => 'E-Mail-Adresse',
  'usersettings:statistics:label:email' => 'E-Mail-Adresse',
  'installation:siteemail' => 'E-Mail-Adresse Deiner Community-Seite (wird vom System verwendet, um Benachrichtigungen zu versenden)',
  'email:settings' => 'E-Mail',
  'email:address:label' => 'E-Mail-Adresse',
  'email:save:success' => 'Die neue E-Mail-Adresse wurde gespeichert. Eine Verifizierungs-Email wurde versandt.',
