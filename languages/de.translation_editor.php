<?php
/*
 * Translation for translation_editor
 * @package translation_editor
 * @subpackage Languages.German
 */
$de_extend = array(
  'translation_editor:action:cleanup:remove:success' => 'Diese Datei wurde gelöscht',
  'translation_editor:action:cleanup:remove:error:remove' => 'Beim Löschen der Datei ist ein Fehler aufgetreten, bitte versuche es erneut',
  'translation_editor:action:cleanup:remove:error:no_file' => 'Die zu löschende Datei konnte nicht gefunden werden',
  'translation_editor:gatekeeper' => 'Du bist kein Übersetzer',
  'translation_editor:show_language_selector' => 'Zeige Sprachwahl',
  'translation_editor:hide_language_selector' => 'Verstecke Sprachwahl',
  'translation_editor:menu:title:plugin' => 'Übersetze %s mit %s',
  'translation_editor:cleanup:description' => '%d manuelle Übersetzungen wurde aufgeräumt. Das bedeutet, sie konnten nicht im entsprechenden Plugin gefunden werden, für das sie erstellt wurden, Du kannst die Liste jetzt herunterladen.
Wenn du fertig bist, kannst du die Datei %s',
  'translation_editor:search' => 'Suchergebnisse für \'%s\' in %s',
